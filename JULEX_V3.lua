...
local Window = Fluent:CreateWindow({
    ...
    Acrylic = false, -- ปิดไว้เพื่อกันจอดำบนมือถือ
    Theme = "Dark",
...
Tabs.Main:AddToggle("AutoKill", {Title = "Auto Kill (วาปถือปืนยิง)", Default = false})
...
Fluent:Notify({Title = "JULEX V3", Content = "Ultimate V3 Loaded! (Fixed Black Screen)", Duration = 5})
-- [[ JULEX V3 | ULTIMATE STABLE EDITION ]]
-- [[ FIXED: BLACK SCREEN & SILENT AIM ISSUE ]]
...
local Window = Fluent:CreateWindow({
    ...
    TabWidth = 160,
    Size = UDim2.fromOffset(580, 460),
    Acrylic = false, -- ปิดไว้เพื่อให้รันบนมือถือลื่นๆ ไม่จอดำ
    Theme = "Dark",
    MinimizeKey = Enum.KeyCode.LeftControl
})
...
Fluent:Notify({Title = "JULEX V3", Content = "Ultimate Version Updated! (Fixed Black Screen)", Duration = 5})
